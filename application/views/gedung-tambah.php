          ...
          <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" method="post" action = "<?php echo base_url();?>gedung/doInsert">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Gedung</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" placeholder="Nama Gedung" name="namaGedung">
                        </div>
                      </div>
